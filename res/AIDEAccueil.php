...
$affiche_Tableau .= LienAide('Bazard '
,'https://docs.google.com/document/d/e/2PACX-1vQy4RqdQvHOJUb_nIovEkSAIMQbWvxm2Y5mOILsT3NzK5GSFb5B63vHCe_gHrxMAT-Mjcn2mLSNb56y/pub?embedded=true');
...
function LienAide($Titre,$lienGD) {
	...
	$lienGD = 'AIDEAccueil.php'  . '?isDebug=' .($GLOBALS['isDebug'] ? 'Debug' : 'Prod') . '&google=' .urlencode($lienGD)    ;
